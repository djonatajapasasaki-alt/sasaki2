...
const STYLES = {
  ...
  MIN: { color: '#FF1744', width: 2 },
  CME: { color: '#FFE000', width: 2 },
  OC1: { color: '#FF6D00', width: 2 },
  BASE: { color: '#B000FF', width: 2 },
  D1: { color: '#00E676', width: 2 },
  D2: { color: '#00E676', width: 2 },
  PX1: { color: '#FF1493', width: 2 },
