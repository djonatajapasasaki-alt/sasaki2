...
if (!groovy.includes('getInput_Double("J JUSTO"') || !groovy.includes('newLines()') || !groovy.includes('newLineData()') || !groovy.includes('r = linhas;')) throw new Error('Indicador Tryd anterior não contém a estrutura esperada.');
