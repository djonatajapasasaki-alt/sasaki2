...
if (groovy.includes('getInput_Double(') || !groovy.includes('double p1 = 5125.5000;') || !groovy.includes('newLines()') || !groovy.includes('newLineData()') || !groovy.includes('r = linhas;')) throw new Error('Indicador Tryd compacto não contém a estrutura esperada.');
